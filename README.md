# 👋 Hello! I'm Millena Sangela

🎓 **Software Engineer** | 💻 **Full-Stack Enthusiast** | 🤖 **Automation & RPA Explorer**

---

## 💫 About Me:
I'm a **Software Engineer** with a passion for **web development** and **automation**. I enjoy working on **full-stack** projects and creating dynamic and interactive web applications. I'm currently diving deep into **Python**, **JavaScript**, and **TypeScript**, and working with **Prisma**, **Node.js**, and **Express** to build powerful web experiences.

In addition to my love for coding, I also explore **automation and RPA** technologies to streamline tasks and improve efficiency. I have a growing interest in **hyperautomation** and love experimenting with **BotCity** and other automation tools.

---

## 🌐 Socials:
[![Behance](https://img.shields.io/badge/Behance-1769ff?logo=behance&logoColor=white)](https://behance.net/www.behance.net/millenasales) [![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?logo=Instagram&logoColor=white)](https://instagram.com/https://instagram.com/millena_sales01) [![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/https://www.linkedin.com/in/millenasangela/) 
...
## 💼 Current Projects
- **Hyperautomation Challenges**: Working with Python and BotCity to automate tasks like form filling, CEP lookup, and reporting.
- **Web Store Project**: Implementing a web store with full CRUD functionality, using JSON as a database.

---


## 🌱 What I'm Learning
- **Full-Stack Development**: Enhancing my skills with **Node.js**, **Express**, and **Prisma**.
- **Database Modeling**: Designing and implementing database schemas with **MySQL**.
- **Hyperautomation**: Deep diving into **advanced RPA** and automating real-world workflows.
...
---
[![](https://visitcount.itsvg.in/api?id=millenas&icon=7&color=10)](https://visitcount.itsvg.in)
